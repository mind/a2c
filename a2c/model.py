...
class Model(object):
    ...
    def __init__(self, policy, ob_space, ac_space, nenvs, nsteps, nstack,
                 num_procs, ent_coef=0.01, vf_coef=0.5, max_grad_norm=0.5,
                 lr=7e-4, alpha=0.99, epsilon=1e-5, total_timesteps=int(80e6),
                 lrschedule='linear'):
...
def learn(policy, env, seed, nsteps=5, nstack=4, total_timesteps=int(80e6),
    ...
    model = Model(
        ...
        nsteps=nsteps, nstack=nstack, num_procs=num_procs, ent_coef=ent_coef,
